...
function application_build_versioned_components()
{
  ...
  # - rv32imac, rv32imafc: for WCH QingKe V4 series (xw!)
  ...
  then
    ...
    XBB_NEWLIB_VERSION="4.5.0.20241231" # "4.4.0.20231231"
    ...
    # Requires `scripts/helper/extras/python/pyconfig-win-3.13.7.h` &
    # `python3-config-win.sh`
    export XBB_PYTHON3_VERSION="3.13.7" # "3.12.2"
    ...
    XBB_LIBICONV_VERSION="1.17" # "1.17"
    ...
    XBB_LIBUNISTRING_VERSION="1.4.1" # "1.2"

    # https://ftp.gnu.org/pub/gnu/gettext/
    XBB_GETTEXT_VERSION="0.25" # "0.22.5"
